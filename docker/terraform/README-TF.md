...
* **Create and Configure `.env` File:**
    ...
    * You'll need to manually fill out the GITHUB_APP_PRIVATE_KEY/GITHUB_ENTERPRISE_APP_PRIVATE_KEY within the generated .env file. We're working on improving this.
    You can convert your Github app private key into one string by running this in a separate terminal and copy pasting its output to the ENV variable, wrapping it as a single-line string: 
        ```bash
