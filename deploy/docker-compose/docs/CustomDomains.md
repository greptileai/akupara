...
We use a reverse proxy service [Caddy](https://caddyserver.com/docs/) to route requests to the correct services on our application. The entire Caddy configuration lives in `deploy/docker-compose/Caddyfile`. 
