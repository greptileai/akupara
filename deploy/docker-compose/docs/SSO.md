...
First ensure that the jackson service has a custom domain and is accessible via HTTPS connection. See `deploy/docker-compose/docs/CustomDomains.md` for more information. 
